...
var AI_MODELS = [
  ...
  { id:"openai/gpt-5.6-luna",                lab:"GPT-5.6 Luna",           cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"openai/gpt-5.6-luna-pro",            lab:"GPT-5.6 Luna Pro",       cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"x-ai/grok-4.6",                      lab:"Grok 4.6",               cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"xiaomi/mimo-v2.5",                   lab:"Xiaomi MiMo V2.5",       cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"moonshotai/kimi-k3",                 lab:"Kimi K3",                cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"anthropic/claude-opus-5",            lab:"Claude Opus 5",          cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"openai/gpt-5.6-sol",                 lab:"GPT-5.6 Sol",            cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"minimax/minimax-m3",                 lab:"MiniMax M3",             cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
  { id:"openai/gpt-oss-120b:nitro",          lab:"GPT-OSS 120B (Nitro)",   cost:"Unverified",
    note:"Added on request — I can't confirm pricing or quality on Gujlish. Use Save & test before relying on it." },
...
function gjBurstRule(burst){
  ...
  var maxLines = burst === "longer" ? "2-5" : "2-3";
  var rule = "Real texting is rarely one smooth sentence stitched together with commas or 'and'. The moment a reply has more than one distinct beat — " +
    ...
    "For example, replying about coming to office tomorrow becomes four separate lines: 'Haa' / 'kal jarur aavish' / 'Tare kai kaam hatu' / " +
    "'ke bas vaat karvi hati?' — never 'Haa, kal jarur aavish' or 'Tare kai kaam hatu, ke bas vaat karvi hati?' joined on one line with a comma. " +
    "The only exception is a plain list of items in one breath (like 'bread, milk, eggs') where the commas aren't separating distinct beats at all.";
  if(burst === "longer")
    rule += " Longer mode's ceiling goes up to 5 lines when the content genuinely supports that many distinct beats — but don't force every burst " +
      "up to the max. The real count should vary naturally from message to message depending on how many genuine beats are actually present: " +
      "sometimes that's 2, sometimes it's 5. Actively look for every distinct beat available (a greeting or reaction, a status update, a feeling, " +
      "a question back) rather than stopping at the very first split you notice, but never invent a beat that isn't genuinely there just to hit a " +
      "target count.";
  return rule;
}
...
function gjBurstJsonHint(burst){
  ...
  var maxLines = burst === "longer" ? "2-5" : "2-3";
  return '"text" should split into ' + maxLines + ' short lines separated by \\n whenever the reply has more than one beat (see above) — the exact count should vary naturally message to message, not hit the same number every time. One line only when there\'s genuinely just a single thought.';
}
...
function gjRunGenerate(){
  ...
  if(mode === "translate"){
    ...
    user = (mode === "reply" ? "Incoming message: " : "Message to rewrite: ") + JSON.stringify(input) + "\n\n" +
      ...
      (S.gj.burst === "longer" ? " You're in Longer mode — the ceiling is 5 lines, but vary the actual count naturally with how many genuine beats this specific message has, not the same number every time." : "") : "");
